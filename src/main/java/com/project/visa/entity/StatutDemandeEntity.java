...
public class StatutDemandeEntity {
    ...
    public static final int STATUT_PHOTOSIGNATURE = 15;
    ...
    static {
        ...
        STATUT_LIBELLES.put(STATUT_PHOTOSIGNATURE, "Photo et signature Termine");
        STATUT_LIBELLES.put(STATUT_SCANNE, "Scanné Termine");
