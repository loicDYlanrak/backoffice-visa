<div id="sidebar">
    ...
    <ul class="list-unstyled components p-3">
        ...
        <%-- <li class="mb-2">
            <a href="${pageContext.request.contextPath}/test/list" class="text-white text-decoration-none">
                <i class="bi bi-list-ul"></i> Liste des Tests
            </a>
        </li>
        <li class="mb-2">
            <a href="${pageContext.request.contextPath}/test/create" class="text-white text-decoration-none">
